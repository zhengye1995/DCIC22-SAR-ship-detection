...
evaluation = dict(interval=36, metric='bbox', iou_thrs=[0.5])
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/user_data/train_work_dirs/cascade_convnext_base_large_scale_only_train_data_36ep_imagenet22k_pretrain_noflip_anchor4_5_3_3_4_5_ratio'
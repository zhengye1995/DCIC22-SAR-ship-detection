...
resume_from = None
workflow = [('train', 1)]
work_dir = '/data/user_data/train_work_dirs/cascade_swin_small_large_scale_only_train_data_36ep_imagenet22k_pretrain_noflip_anchor4_5_3_3_4_5_ratio_mosaic'